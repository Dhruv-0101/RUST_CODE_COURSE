...
fn main() {
    ...
    // Pura 'Value' (Owner) return kardo!
    let my_age = get_my_age();
    println!(
...
// ✅ THE CORRECT WAY 🏭
// ------------------------------
// Feel: "Main Address (Reference) nahi, balki puri 'Cheez' (Value) hi
// aapko de raha hoon. Ab aap iske naye Owner ho!"
fn get_my_age() -> i32 {
    let age = 32;
    age // ✅ SUCCESS! Ownership 'age' se Caller (main) ko MOVE ho jayegi.
}
